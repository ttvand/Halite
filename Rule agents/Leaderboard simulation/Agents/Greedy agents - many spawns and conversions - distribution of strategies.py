...
CONFIGS = {
  "halite_config_setting_divisor": [100.0, 1000.0], 
  "max_ship_to_base_ratio": [2, 6], 
  "min_spawns_after_conversions": [0, 3], 
  "max_conversions_per_step": [2, 10], 
  "friendly_ship_halite_conversion_constant": [0.1, 0.5],
  "friendly_bases_conversion_constant": [0.1, 4], 
  "nearby_halite_conversion_constant": [0.001, 0.3], 
  "conversion_score_threshold": [-1, 1], 
  "halite_collect_constant": [50, 100], 
  "nearby_halite_move_constant": [0.2, 3], 
  "nearby_onto_halite_move_constant": [10, 20], 
  "nearby_ships_move_constant": [0.01, 0.05], 
  "nearby_base_move_constant": [5, 30], 
  "nearby_move_onto_base_constant": [5, 20], 
  "halite_dropoff_constant": [50, 100], 
  "max_spawns_per_step": [2, 10], 
  "nearby_ship_halite_spawn_constant": [0.3, 3], 
  "nearby_halite_spawn_constant": [0.3, 3], 
  "remaining_budget_spawn_constant": [0.001, 0.005], 
  "spawn_score_threshold": [-1, 10], 
