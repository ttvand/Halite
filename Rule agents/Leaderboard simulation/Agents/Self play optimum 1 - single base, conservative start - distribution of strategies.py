...
CONFIGS = {
  "halite_config_setting_divisor": [2843.823213080802, 3057.867409810601],
  "max_ship_to_base_ratio": [5.226603262499999, 8.019952446875],
  "min_spawns_after_conversions": [0.5144249999999999, 2.957943749999999],
  "max_conversions_per_step": [13.832018888812495, 18.87401416660937],
  "friendly_ship_halite_conversion_constant": [0, 0.09037421639702622], 
  "friendly_bases_conversion_constant": [12.351635282490179, 13.188726461867637],
  "nearby_halite_conversion_constant": [0, 0.052272559802415304], 
  "conversion_score_threshold": [5.282889888456495, 5.712167416342369], 
  "halite_collect_constant": [0, 8.741230736189848], 
  "nearby_halite_move_constant": [0, 1.1122000916830106], 
  "nearby_onto_halite_move_constant": [0, 1.74824614723797], 
  "nearby_ships_move_constant": [0, 0.023949477569535145], 
  "nearby_base_move_constant": [0, 8.51404065720287], 
  "nearby_move_onto_base_constant": [0, 3.755161346136825],
  "halite_dropoff_constant": [0, 12.517204487122743], 
  "max_spawns_per_step": [1, 5.322880701301092], 
  "nearby_ship_halite_spawn_constant": [0, 0.7883703657146854], 
  "nearby_halite_spawn_constant": [0, 0.7115042550575036], 
  "remaining_budget_spawn_constant": [0.010962342359435077, 0.012471756769576308],
  "spawn_score_threshold": [21.542300918916673, 26.906725689187496], 
  "ship_halite_cargo_conversion_bonus_constant": [0, 5],
  }
...
def sample_from_config(config):
  sampled_config = {}
  for k in config:
    sampled_config[k] = np.random.uniform(config[k][0], config[k][1])
...
def decide_ship_convert_actions(
  ...
  max_conversions = int((
     remaining_budget - config['min_spawns_after_conversions']*spawn_cost)/(
      convert_cost))
  max_conversions = min(max_conversions, int(
    config['max_conversions_per_step']))
