...
CONFIG = {
  ...
  'collect_actual_multiplier': 2.5,
  'return_base_multiplier': 3.0,
  
  'establish_base_smoothed_multiplier': 0.25,
  'establish_base_deposit_multiplier': 1.0,
  'collect_run_enemy_multiplier': 4.0,
  'return_base_run_enemy_multiplier': 4.0,
  'establish_base_run_enemy_multiplier': 4.0,
  
  'collect_catch_enemy_multiplier': 4.0,
  'return_base_catch_enemy_multiplier': 0.5,
  'establish_base_catch_enemy_multiplier': 4.0,
  'ignore_catch_prob': 0.25,
  'max_ships': 17,
  
  'max_spawns_per_step': 1,
  'nearby_ship_halite_spawn_constant': 2.0,
  'nearby_halite_spawn_constant': 10.0,
  'remaining_budget_spawn_constant': 0.01,
  'spawn_score_threshold': 20.0,
