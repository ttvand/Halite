...
CONFIG = {
  ...
  'early_game_return_base_additional_multiplier': 5.0,
  'early_game_return_boost_step': np.random.randint(50, 150),
  'end_game_return_base_additional_multiplier': 10.0,
  'establish_base_smoothed_multiplier': 0.5,
  'establish_first_base_smoothed_multiplier_correction': 0.5,
  ...
  'max_ships': np.random.randint(15, 26),
  ...
  'max_spawn_relative_step_divisor': np.random.randint(20, 100),
  }
